...
Scenario Outline: Generate an order
 ...
 #   When the admin clicks search
	...
	#And the user clicks on profile button
	...
	Examples: 
	 | Example Description | test_kit       | name | last_name | price  | quantity | tracking_code          | carrier |
	 | standard            | Women’s Health | Jesus | Automate Order | 299.00 | 1        | 9114999999999999999999 | Fedex   |
